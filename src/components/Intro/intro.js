        ...
        <section id="intro">
            <div className="introContent">
                <div className="revealText">
                    ...
                    <div className="titleText" aria-level="2" role="heading">Chief Architect for Office of CTO <br />and Managing Director</div>
                    <div className="titleText" aria-level="2" role="heading">at Ernst and Young</div>
